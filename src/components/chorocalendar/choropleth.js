...
angular.module('studentdashboard')
  .directive('choropleth', [ '$window', function($window) {
    return {
      scope: {
      },
      restrict: 'E',
      templateUrl: 'components/chorocalendar/choropleth.html',
      replace: true,
      ...
      link: function(scope, elem){
        ...
        d3.csv('assets/images/choroExample.csv', function(error, csv) {
          var data = d3.nest()

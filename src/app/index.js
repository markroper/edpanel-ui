'use strict';
angular.module('teacherdashboard', ['ngAnimate', 'ngCookies', 'ngSanitize', 'ngResource', 'ui.router',
  'ngMaterial', 'ui.grid', 'ui.grid.pagination', 'angular-sortable-view', 'gridster','gantt','gantt.tooltips',
  'gantt.table','gantt.groups','gantt.tree','ui.tree', 'ngFileUpload'])
